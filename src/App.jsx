...
useEffect(() => {
  ...
  socket.on('game_created', (data) => {
    ...
    // Don't call initializeGame here with dependencies
  ...
  socket.on('game_state_update', (data) => {
    ...
    if (data.status === 'finished') {
      ...
      // Fetch moves based on player color
      const storedColor = data.turn; // Use current turn from state
