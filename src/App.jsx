            ...
            <div className="bg-gray-800 rounded-xl p-6 border-2 border-green-600">
              ...
              {board.length > 0 && (
                <div className="mt-6 flex justify-between items-stretch gap-4">
                  ...
                  {/* Player 1 (Black) Score Card */}
                  <div 
                    className={`flex-1 p-4 rounded-xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-2 
                    ${currentPlayer === 1 
                      ? 'bg-gray-800 border-green-400 shadow-[0_0_15px_rgba(74,222,128,0.2)] scale-105 z-10' 
                      : 'bg-gray-800/50 border-gray-700 opacity-70 scale-100'}`}
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <div className="w-6 h-6 rounded-full bg-gray-900 border-2 border-gray-600 shadow-inner" />
                      <span className={`font-bold uppercase tracking-wider text-sm ${currentPlayer === 1 ? 'text-green-400' : 'text-gray-500'}`}>
                        Black
                      </span>
                    </div>
                  ...
                  {/* Player 2 (White) Score Card */}
                  <div 
                    className={`flex-1 p-4 rounded-xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-2 
                    ${currentPlayer === 2 
                      ? 'bg-gray-800 border-white shadow-[0_0_15px_rgba(255,255,255,0.2)] scale-105 z-10' 
                      : 'bg-gray-800/50 border-gray-700 opacity-70 scale-100'}`}
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <div className="w-6 h-6 rounded-full bg-white border-2 border-gray-300 shadow-inner" />
                      <span className={`font-bold uppercase tracking-wider text-sm ${currentPlayer === 2 ? 'text-white' : 'text-gray-500'}`}>
                        White
                      </span>
                    </div>
                    <span className="text-5xl font-black text-white tracking-tighter">
